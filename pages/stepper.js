...
import { useBoop, Boop } from '../components/hooks/use-boop'
    ...
    <div className='p-8 h-screen w-screen grid place-items-center grid-cols-1 gap-8 overflow-y-scroll'>
      ...
      {/* <Stepper className='bg-gray-300 w-9/12'>
        <Indicators className='p-4'>
          {stepList.map(step => <Indicator key={JSON.stringify(step)} className='bg-primary-reg hover:bg-primary-light py-2 text-white rounded-full px-4'>
            {step}
          </Indicator>)
          }
        </Indicators>
